<%-- 
    Document   : add
    Created on : Jun 11, 2018, 8:15:39 AM
    Author     : namph
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row" >
                    <label for="name" class="col-md-4 control-label required" >Mã</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="add-code" 
                               name="code" maxlength="300" required="required">
                    </div>
                </div>
                <div class="form-group row" >
                ...
                <div class="form-group row" >
                    <label for="address" class="col-md-4 control-label required">Số tiền</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="add-money"
                               name="money" maxlength="300">
                    </div>
                </div>
                <div class="form-group row" >
                    <label for="phone" class="col-md-4 control-label required">Nội dung</label>
                    <div class="col-md-8">
