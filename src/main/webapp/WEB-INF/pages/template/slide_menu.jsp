    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <% }%>
                <!--                <ul class="treeview-menu">
                                    <li><a href="<%=request.getContextPath()%>/g_product"><i class="fa fa-angle-double-right"></i>Nhóm sản phẩm</a></li>
                                                        <li><a href="<%=request.getContextPath()%>/products"><i class="fa fa-angle-double-right"></i>Sản phẩm</a></li>
                                                        <li><a href="<%=request.getContextPath()%>/unit"><i class="fa fa-angle-double-right"></i>Đơn vị</a></li>
                                    <li><a href="<%=request.getContextPath()%>/customer"><i class="fa fa-angle-double-right"></i>Đại lý- Khách hàng</a></li>
                                    <li><a href="<%=request.getContextPath()%>/employee"><i class="fa fa-angle-double-right"></i>Nhân viên tiếp thị</a></li>
                                    <li><a href="<%=request.getContextPath()%>/bank"><i class="fa fa-angle-double-right"></i>Tài khoản ngân hàng</a></li>
                                </ul>-->
            </li>
            <%}
                    }
